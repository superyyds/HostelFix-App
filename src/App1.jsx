...
//             const newUserData = {
//                 UserID: hostelId, // Use HostelID as the UserID for simulation simplicity
//                 Email: email,
//                 Name: name,
//                 Role: role,
...
//             if (isVoluntary) {
//                 setTimeout(() => {
//                     if (onCancel) onCancel(); // onCancel is set to navigate back to profile-management
//                 }, 1500); 
//             } else {
//                 onForcedPasswordChangeComplete(); // Mandatory change navigates immediately to Dashboard via App state update
//             }
...
//                     {newPassword && !/(?=.*[a-zA-Z])(?=.*[0-9])/.test(newPassword) && (
//                         <div className="mb-4 p-2 bg-yellow-50 border border-yellow-200 rounded text-yellow-700 text-sm">
//                             Password must contain letters and numbers.
//                         </div>
//                     )}
//                     {newPassword && !/(?=.*[^a-zA-Z0-9\s])/.test(newPassword) && (
//                         <div className="mb-4 p-2 bg-yellow-50 border border-yellow-200 rounded text-yellow-700 text-sm">
...
//                             <PrimaryButton 
//                                 onClick={handleSave} 
//                                 className="w-auto px-6 py-2 bg-green-600 hover:bg-green-700 text-sm"
//                                 disabled={isLoading}
//                             >
...
//     if (!firebaseConfig) {
//         setAppState(prev => ({ ...prev, loading: false, error: "Firebase config missing." }));
//         return;
//     }
...
//                     onPasswordChange={() => handleViewChange('change-password')} // FIX: Use handleViewChange for consistent navigation
//                 />;

//       case "change-password": // Reused for voluntary and mandatory change
//         return <ChangePasswordPage 
//                     onForcedPasswordChangeComplete={handleForcedPasswordChangeComplete}
//                     userId={appState.userId}
//                     userDocId={appState.userDocId}
